    ...
    if (gameMap.getPowerUps().size() < 3) {
        ...
        if (gameMap.occupiedCells[powerUpX][powerUpY] == 0) {
            switch (randomPowerUp.nextInt(2)) {
                case 0:
                    gameMap.gameObjs.add(new Sword(powerUpX, powerUpY, "excalibur", gameMap));
                    break;
                case 1:
...
private void generateMonsters(GameMap gameMap){
...
private void checkEndGame(BasePlayer player, GameMap gameMap){
